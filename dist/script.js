...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.accordion = function (headActive = 'accordion-head--active', contnetActive = 'accordion-content--active', paddings = 40) {
  for (let i = 0; i < this.length; i++) {
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(() => {
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).toggleClass(headActive);
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i].nextElementSibling).toggleClass(contnetActive);
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    modal.setAttribute('id', this[i].getAttribute('data-target').slice(1)); // btns = {count: num, setting: [[text, classNames=[], close, cb]]}
...
$.prototype.init = function (selector) {
  ...
  Object.assign(this, document.querySelectorAll(selector)); // add property length in the prototype

  this.length = document.querySelectorAll(selector).length; // return all object
...
$.prototype.init.prototype = $.prototype; // add constant $ in global
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.animatedOverTime = function (duration, cb, fin) {
  let timeStart = null;
...
$('.reds').addClass('Hi'); // $('button').eq(2).on('click', () => {
//     $('.w-33').fadeOut(800);
// });
